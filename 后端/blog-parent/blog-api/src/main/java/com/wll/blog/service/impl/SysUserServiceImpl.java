...
import com.wll.blog.dao.mapper.SysUserMapper;
import com.wll.blog.dao.pojo.SysUser;
import com.wll.blog.dao.vo.ErrorCode;
import com.wll.blog.dao.vo.LoginUserVo;
...
public class SysUserServiceImpl implements SysUserService {
    ...
    public SysUser findUser(String account, String password) {
        ...
        //添加条件，只查这几个字段，以及在末尾limit 1（查出一条就结束）
    ...
    public void save(SysUser sysUser) {
        //保存用户 id会自动生成
        //默认生成的id是 分布式id 雪花算法 以后用户多了之后，要进行分表操作，id就需要用分布式id 了
